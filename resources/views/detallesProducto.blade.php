        ...
        <div class="container mt-5">
            <div class="row gy-4 justify-content-center">
                ...
                <div class="col-lg-4">
                    ...
                    {{-- Tarjeta del descripción del producto  --}}
                    <div class="card">
                        <div class="card-body">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Ponte en contacto con el negocio para obtener mayores detalles
                                        sobre este producto.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="game-card">
                                        <div class="game-card__box">
                                            <div class="game-card__media"><img class="rounded-3" src="img/Productos/C1.jpg"
                                                    alt="image"></div>
