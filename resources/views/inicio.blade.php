...
<section class="sobrenosotros" id="nosotros">
  <div class="container">
    <div class="card mb-12 b5 px-2 py-2 mt-2">
      <div class="row g-0">
        ...
        <div class="col-md-9">
          <div class="card-body">
            ...
            <p>Multi emprende es una plataforma de proyección de los emprendimientos en Nicaragua que permite a las mentes creativas exponer sus productos o servicios en un espacio compartido en la web y cuyo enfonque es cultivar la seguridad de la información que se comparte con el público nicaragüense.
            </p>
...
<!--INICIO DE TARJETAS-->
<div class="uk-width-1-1 mt-2" id="negocios">
...
<section id="servicios">
  <div class="container">
    <h2 class="titulo text-center mt-2">SERVICIOS</h2>
